...
function roots_scripts() {
    ...
    wp_enqueue_style('app', get_template_directory_uri() . '/assets/css/app.min.css', false, time());
//    wp_enqueue_style('fonts', get_template_directory_uri() . '//cloud.typography.com/6870472/797184/css/fonts.css', false, time());
    ...
    wp_register_script('app', get_template_directory_uri() . '/assets/js/app.min.js', false, null, false);
